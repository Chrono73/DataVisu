...
\subsection{Implémentation Python de l'\emph{Algorithme de Walker} \cite{article90}}

\subsection{Implémentation Python de l'\emph{Algorithme de Walker} amélioré \cite{article02}}
