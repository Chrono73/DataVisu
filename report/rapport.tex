...
\newpage
  ...
  Le premier algorithme (\emph{Algorithme 1}) de dessin d'arbre d'écrit par cet article est \emph{l'algorithme d'arbre naïf}. Il a comme objectif de repondre à la \emph{Limite Physique 1} en optimisant l'espace du graphe.

  Il prend en entrée un arbre, tel que nous l'avons défini plus haut et retourne en sortie le même arbre dans lequel la position des n\oe{}ud à changer pour faire en sorte qu'il ai la largeur la plus étroite possible. 
